...
@WebServlet("/api/composition/journey")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class JourneyQuery extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            DB db = mc.getDB("journey_planning");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(parameterMap.size() == 3 && parameterMap.containsKey("train_id") && parameterMap.containsKey("coach_id") && parameterMap.containsKey("coach_position")){
                ...
                DBCollection collection = db.getCollection(parameterMap.get("train_id")[0]);
                collection.insert(new BasicDBObject().append("coach_id", parameterMap.get("coach_id")[0]).append("coach_position", parameterMap.get("coach_position")[0]).append("timestamp", new java.util.Date()));
